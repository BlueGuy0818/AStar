...
namespace DBC
{
	...
	public:
		...
		//查找某列等于指定值的第nRow行
		virtual const FIELD*	Search_Column_Equ(INT nRow,INT nColumnNum, const FIELD& value) const;
	public:
		//取得ID
	...
	public:
		...
		//比较两个值是否相等
		static bool			_FieldEqu(const FIELD& a, const FIELD& b, FIELD_TYPE ftype);
